...
import static ru.topjava.graduation.data.UserTestData.OWNER_2;
...
public class MealTestData {
    ...
    public static final Meal MEAL_1 = new Meal(MEAL_1_ID, "ChickenBurger set", 300, OWNER_1);
    public static final Meal MEAL_2 = new Meal(MEAL_2_ID, "CheeseBurger set", 400, OWNER_1);
    public static final Meal MEAL_3 = new Meal(MEAL_3_ID, "FishBurger set", 500, OWNER_1);

    public static final Meal MEAL_4 = new Meal(MEAL_4_ID, "BigMac set", 300, OWNER_2);
    public static final Meal MEAL_5 = new Meal(MEAL_5_ID, "Happy Meal set", 400, OWNER_2);

    public static final Meal MEAL_6 = new Meal(MEAL_6_ID, "Sanders lunch basket", 300, OWNER_2);
    public static final Meal MEAL_7 = new Meal(MEAL_7_ID, "Lunch basket \"5 items\"", 400, OWNER_2);
    ...
    public static final String OWNER_REST_1_MEALS_URL = "/my" + REST_1_MEALS_URL;

    public static final String OWNER_REST_1_FUTURE_MEALS_URL = OWNER_REST_1_MEALS_URL + "/future";
