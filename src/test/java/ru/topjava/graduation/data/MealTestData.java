...
public class MealTestData {
    ...
    public static final Meal OLD_MEAL_1_REST_1 = new Meal(100, "Lunch1_1", 300, LocalDate.of(2019, 5, 31), ADMIN_1);
    public static final Meal OLD_MEAL_2_REST_1 = new Meal(200, "Lunch2_1", 300, LocalDate.of(2019, 5, 31), ADMIN_1);
    public static final Meal OLD_MEAL_3_REST_1 = new Meal(300, "Lunch3_1", 300, LocalDate.of(2019, 5, 31), ADMIN_1);
