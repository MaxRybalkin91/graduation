...
public class UserTestData {
    public static final User OWNER_1 = new User(1, "admin1", "admin");
    public static final User OWNER_2 = new User(2, "admin2", "admin");
    public static final User OWNER_3 = new User(3, "admin3", "admin");
